...
borough_plan_text, file_names = parse_file(
    [open("Lambeth_2030-Our_Future_Our_Lambeth.pdf")]
)
...
embed_faiss_save_to_zip(
    borough_plan_docs,
    save_folder="borough_plan",
    embeddings_model_object=embeddings,
    save_to="faiss_embedding",
